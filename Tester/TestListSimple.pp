...
uses
  ...
  function TestListSimpleAppend   (AList: PListSimple; ANodeNum: Int32): Int64; // Measures the speed of adding a given number of nodes to a list.
  function TestListSimpleInsert   (AList: PListSimple): Int64; // Measures the speed of inserting a given number of nodes into a list.
  function TestListSimpleChop     (AList: PListSimple): Int64; // Measures the speed of removing nodes from a list.
  function TestListSimpleSort     (AList: PListSimple): Int64; // Measures the speed of sorting nodes in a list.
  function TestListSimpleClear    (AList: PListSimple): Int64; // Measures the speed of list cleaning.
  function TestListSimpleTraverse (AList: PListSimple): Int64; // Measures the speed of iterating over the nodes of a list.
  function TestListSimpleDestroy  (AList: PListSimple): Int64; // Measures the speed of cleaning and destroying the list.
